...
public class PeopleAPITest {
    ...
    String path = Data.getBaseUrl() + Data.getPeople();
    int firstID = 1;
    int maxID = 83;
    int invalidCountOfPeople = maxID + 1;

    @Test
    public void requestPeopleOk() {
        given()
                .spec(requestSpec)
                .when()
                .get(path)
    ...
    @Test
    public void requestPeopleWithValidIdIsOk() {
        given()
                .spec(requestSpec)
                .when()
                .get(path + maxID)
    ...
    @Test
    public void haveAccessToPeopleByID() {
        given()
                .spec(requestSpec)
                .when()
                .get(path + firstID)
    ...
    @Test
    public void peopleMatchesJSONSchema() {
    ...
    @Test
    public void invalidCountOfPeopleShouldError() {
        given()
                .spec(requestSpec)
                .when()
                .get(path + invalidCountOfPeople)
                .then()
                .statusCode(404);
    }
